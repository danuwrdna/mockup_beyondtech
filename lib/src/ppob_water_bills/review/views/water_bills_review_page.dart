...
class WaterBillsReviewPage extends StatelessWidget {
  const WaterBillsReviewPage({
    super.key,
    this.paymentMethod,
  ...
  static const String qrContent =
      "00020101021126680016ID.CO.BPDDIY.WWW011893600112005000009002150112005000009080303URE51440014ID.CO.QRIS.WWW0215ID20200584181590303URE5204939953033605802ID5918KPPD SAMSAT SLEMAN6006SLEMAN61055551462070703A016304B01A";
  static const num uniqueCode = 177;
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Expanded(
                            child: Text(
                              "Finish Before ${DateFormat("dd MMM yyyy, HH:mm").format(DateTime.fromMillisecondsSinceEpoch(paymentData!.expiredAt * 1000))} WIB",
                            ...
                            child: Row(
                              ...
                              children: [
                                if (paymentMethod?.paymentCode.toUpperCase() ==
                                  ...
                                  Expanded(
                                    child: Text(
                                      paymentData?.paymentChannel.payCode ?? "",
                                      style: TextStyle(
                                        fontSize: 14.sp,
                                        fontWeight: FontWeightResource.semiBold,
                                      ),
