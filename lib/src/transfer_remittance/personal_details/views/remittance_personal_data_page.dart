import 'package:bpay_mobile/src/transfer_remittance/additional_details/views/remittance_additional_information_page.dart';
import 'package:bpay_mobile/src/transfer_remittance/bank_details/views/remittance_bank_destination_bottom_sheet.dart';
...
class RemittancePersonalDataPage extends StatefulWidget {
  final Map<String, dynamic>? selectedService;
  final Map<String, TextEditingController>? controllers;
  final String? destinationCountryCode;
  final int amount;

  const RemittancePersonalDataPage({
    super.key,
  ...
  @override
  State<RemittancePersonalDataPage> createState() =>
      _RemittancePersonalDataPageState();
}

class _RemittancePersonalDataPageState
    extends State<RemittancePersonalDataPage> {
              ...
              child: Column(
                ...
                children: [
                  ...
                  for (var field in widget.selectedService!['fields']) ...[
                    ...
                    if (field['key'] == "targetAccount.bankName") ...[
                      ...
                      InkWell(
                        onTap: () {
                          showModalBottomSheet(
                            ...
                            context: context,
                            builder: (context) {
                              return RemittanceBankDestinationBottomSheet(
                                description: field['enumerations'],
                                onSelect: (bankName) {
                                  setState(() {
                                    controllers['targetAccount.bankName']!
                                        .text = bankName;
                                  });
                                },
                              );
                        ...
                        child: TextField(
                          controller: controllers['targetAccount.bankName'],
                    ...
                    ] else if (field['key'].contains('receiver.') ||
                        field['key'].contains('targetAccount.') &&
                            field['key'] != "targetAccount.bankName") ...[
                      ...
                      LabeledTextField(
                        ...
                        // Tentukan input formatter berdasarkan regex atau tipe data
                        inputFormatters: [
                          if (field['regex'] != null &&
                              field['regex']!.isNotEmpty) ...[
                            if (field['regex'] == "^/+?1?/d{10}\$") ...[
                              FilteringTextInputFormatter.allow(
                                  RegExp("^([0-9]+)\$"))
                            ] else if (field['key'] ==
                                "targetAccount.homeAddress") ...[
                        ...
                        // Tentukan keyboard type
                        keyboardType: field['data_type'] == 'string'
                            ? TextInputType.text
                            : TextInputType.number,

                        // Gunakan aturan min dan max length jika tersedia
                ...
                onPressed: areAllFieldsFilled()
                    ? () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) {
                              return RemittanceAdditionalInformationPage(
