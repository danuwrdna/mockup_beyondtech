...
_$RemittanceTransactionDetailResponseModelImpl
    _$$RemittanceTransactionDetailResponseModelImplFromJson(
            Map<String, dynamic> json) =>
        _$RemittanceTransactionDetailResponseModelImpl(
          data: RemittanceTransactionDetailData.fromJson(
              json['data'] as Map<String, dynamic>),
          message: json['message'] as String,
          statusCode: json['status_code'] as String,
        );

Map<String, dynamic> _$$RemittanceTransactionDetailResponseModelImplToJson(
        _$RemittanceTransactionDetailResponseModelImpl instance) =>
    <String, dynamic>{
      'data': instance.data,
...
_$RemittanceTransactionDetailDataImpl
    _$$RemittanceTransactionDetailDataImplFromJson(Map<String, dynamic> json) =>
        _$RemittanceTransactionDetailDataImpl(
          boundaryType: json['boundary_type'] as String,
          createdAt: (json['created_at'] as num).toInt(),
          expiredAt: (json['expired_at'] as num).toInt(),
          formatted: RemittanceTransactionDetailDataFormatted.fromJson(
              json['formatted'] as Map<String, dynamic>),
          paidAt: (json['paid_at'] as num).toInt(),
          paymentChannel:
              RemittanceTransactionDetailDataPaymentChannel.fromJson(
                  json['payment_channel'] as Map<String, dynamic>),
          ppobProduct: RemittanceTransactionDetailDataPpobProduct.fromJson(
              json['ppob_product'] as Map<String, dynamic>),
          rate: RemittanceTransactionDetailDataRate.fromJson(
              json['rate'] as Map<String, dynamic>),
          recipients: (json['recepients'] as List<dynamic>)
              .map((e) => RemittanceTransactionDetailDataRecipient.fromJson(
          ...
          totalFee: RemittanceTransactionDetailDataTotalFee.fromJson(
...
Map<String, dynamic> _$$RemittanceTransactionDetailDataImplToJson(
        _$RemittanceTransactionDetailDataImpl instance) =>
    <String, dynamic>{
...
_$RemittanceTransactionDetailDataFormattedImpl
    _$$RemittanceTransactionDetailDataFormattedImplFromJson(
            Map<String, dynamic> json) =>
        _$RemittanceTransactionDetailDataFormattedImpl(
...
Map<String, dynamic> _$$RemittanceTransactionDetailDataFormattedImplToJson(
        _$RemittanceTransactionDetailDataFormattedImpl instance) =>
    <String, dynamic>{
...
_$RemittanceTransactionDetailDataPaymentChannelImpl
    _$$RemittanceTransactionDetailDataPaymentChannelImplFromJson(
            Map<String, dynamic> json) =>
        _$RemittanceTransactionDetailDataPaymentChannelImpl(
...
Map<String, dynamic> _$$RemittanceTransactionDetailDataPaymentChannelImplToJson(
        _$RemittanceTransactionDetailDataPaymentChannelImpl instance) =>
    <String, dynamic>{
...
_$RemittanceTransactionDetailDataPpobProductImpl
    _$$RemittanceTransactionDetailDataPpobProductImplFromJson(
            Map<String, dynamic> json) =>
        _$RemittanceTransactionDetailDataPpobProductImpl(
          desc: RemittanceProductDesc.fromJson(
...
Map<String, dynamic> _$$RemittanceTransactionDetailDataPpobProductImplToJson(
        _$RemittanceTransactionDetailDataPpobProductImpl instance) =>
    <String, dynamic>{
      'desc': instance.desc,
      'formatted': instance.formatted,
...
_$RemittanceProductDescImpl _$$RemittanceProductDescImplFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$RemittanceProductDescImplToJson(
        _$RemittanceProductDescImpl instance) =>
    <String, dynamic>{
...
_$RemittanceTransactionDetailDataRateImpl
    _$$RemittanceTransactionDetailDataRateImplFromJson(
            Map<String, dynamic> json) =>
        _$RemittanceTransactionDetailDataRateImpl(
          formatted: json['formatted'],
...
Map<String, dynamic> _$$RemittanceTransactionDetailDataRateImplToJson(
        _$RemittanceTransactionDetailDataRateImpl instance) =>
    <String, dynamic>{
      'formatted': instance.formatted,
...
_$RemittanceTransactionDetailDataRecipientImpl
    _$$RemittanceTransactionDetailDataRecipientImplFromJson(
            Map<String, dynamic> json) =>
        _$RemittanceTransactionDetailDataRecipientImpl(
...
Map<String, dynamic> _$$RemittanceTransactionDetailDataRecipientImplToJson(
        _$RemittanceTransactionDetailDataRecipientImpl instance) =>
    <String, dynamic>{
...
_$RemittanceTransactionDetailDataTotalFeeImpl
    _$$RemittanceTransactionDetailDataTotalFeeImplFromJson(
            Map<String, dynamic> json) =>
        _$RemittanceTransactionDetailDataTotalFeeImpl(
...
Map<String, dynamic> _$$RemittanceTransactionDetailDataTotalFeeImplToJson(
        _$RemittanceTransactionDetailDataTotalFeeImpl instance) =>
    <String, dynamic>{
