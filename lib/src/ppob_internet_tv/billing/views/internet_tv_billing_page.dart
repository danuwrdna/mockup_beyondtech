...
import 'package:bpay_mobile/src/ppob_internet_tv/detail/views/internet_tv_detail_page.dart';
...
class InternetTvBillingPage extends StatefulWidget {
  const InternetTvBillingPage({
    super.key,
  ...
  @override
  State<InternetTvBillingPage> createState() => _InternetTvBillingPageState();
}

class _InternetTvBillingPageState extends State<InternetTvBillingPage> {
  ...
  void initState() {
    context
        .read<InternetTvInquiryBloc>()
        .add(const InternetTvInquiryEvent.reset());
    ...
    debounce = Timer(
      ...
      () {
        if (customerIdController.text.trim().length >= 4) {
          context.read<InternetTvInquiryBloc>().add(
                InternetTvInquiryEvent.getBillDetail(
                  productId: PpobConst.internetTv,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              BlocBuilder<InternetTvInquiryBloc, InternetTvInquiryState>(
                        ...
                        if (internetTvData.customer.customerName.isNotEmpty) {
                          return Column(
                            ...
                            children: [
                              ...
                              StartEndTextRowWidget(
                                  startText: "Name",
                                  endText: widget.denomination.name),
                              const SizedBox(height: 12),
                              StartEndTextRowWidget(
                                startText: "Custpmer ID",
                              ...
                              StartEndTextRowWidget(
                                ...
                                endText:
                                    internetTvData.taxDetail.formatted.price,
                              ),
                              const SizedBox(height: 12),
                              StartEndTextRowWidget(
      ...
      bottomNavigationBar: Container(
        ...
        child: BlocBuilder<InternetTvInquiryBloc, InternetTvInquiryState>(
          builder: (context, state) {
            return state.when(
                                  ...
                                  Navigator.push(
                                    ...
                                    MaterialPageRoute(builder: (context) {
                                      ...
                                      return InternetTvDetailPage(
                                        ...
                                        packageId: widget.package.id,
                                        packageType: widget.package.packageType,
                                        customerNumber:
