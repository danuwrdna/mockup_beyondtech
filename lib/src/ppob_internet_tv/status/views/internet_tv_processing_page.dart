...
import 'package:bpay_mobile/src/ppob_internet_tv/success/views/internet_tv_success_page.dart';
...
class InternetTvProcessingPage extends StatefulWidget {
  const InternetTvProcessingPage({
    super.key,
  ...
  @override
  State<InternetTvProcessingPage> createState() =>
      _InternetTvProcessingPageState();
}

class _InternetTvProcessingPageState extends State<InternetTvProcessingPage> {
  @override
  void initState() {
                        ...
                        Row(
                          children: [
                            Container(
                              ...
                              child: Center(
                                child: Assets.icons.icInternetAndTv.image(
                                  height: 28,
                                  width: 28,
