...
class EWalletReviewPage extends StatelessWidget {
  const EWalletReviewPage({
    super.key,
                    ...
                    return Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          StartEndTextRowWidget(
                            startText: "Price",
                            endText: convertToIdr(transactionData.price, 0),
                          ),
                          const SizedBox(height: 12),
                          StartEndTextRowWidget(
                            startText: "Admin Fee",
                            ...
                            endTextDecoration: detailData
                                    ...
                                    detailData.paymentMethod.fee.isPaymentFree
