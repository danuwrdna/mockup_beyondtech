...
import 'package:bpay_mobile/src/auth_verification/passport/passport_photo/views/photo_preview_page.dart';
...
class GuidePage extends StatelessWidget {
  const GuidePage({super.key, required this.passportData});

  final PassportVerificationDataModel passportData;

  static List<String> instructions = [
    "Prepare the original passport, not its photocopy.",
