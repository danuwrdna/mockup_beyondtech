...
class ElectricityPaymentReviewPage extends StatelessWidget {
  const ElectricityPaymentReviewPage({
    super.key,
                        ...
                        children: [
                          ...
                          if (productName.toLowerCase().contains("token")) ...[
                            ...
                            StartEndTextRowWidget(
                              ...
                              endText:
                                  billData?.data.customer.customerName ?? "",
                            ),
                            const SizedBox(height: 12),
                            StartEndTextRowWidget(
                              startText: "Billing Amount",
                              endText: convertToIdr(
                                  int.tryParse(billData?.data.taxDetail.desc
                                              .detail.first.nilaiTagihan ??
                                          "") ??
                                      0,
                                  0),
                            ),
                            ...
                            StartEndTextRowWidget(
                              ...
                              endText: convertToIdr(
                                  billData?.data.taxDetail.admin ?? 0, 0),
                            ),
                            if (billData?.data.taxDetail.desc.detail.first.denda
                                    .isNotEmpty ??
                                false) ...[
                              const SizedBox(height: 12),
                              StartEndTextRowWidget(
