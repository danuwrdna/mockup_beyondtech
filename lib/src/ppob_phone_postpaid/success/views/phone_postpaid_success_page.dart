...
class PhonePostpaidSuccessPage extends StatefulWidget {
  const PhonePostpaidSuccessPage({
    super.key,
  ...
  static int uniqueCode = 167;

  @override
  State<PhonePostpaidSuccessPage> createState() =>
      _PhonePostpaidSuccessPageState();
}

class _PhonePostpaidSuccessPageState extends State<PhonePostpaidSuccessPage> {
                  ...
                  Text(
                    DateFormat("( dd MMMM yyyy  |  HH:mm:ss )").format(
                        DateTime.fromMillisecondsSinceEpoch(
                            PhonePostpaidSuccessPage.createdAt * 1000)),
                    style: GoogleFonts.poppins(fontSize: 11.sp),
                  ),
                  const SizedBox(height: 20),
                  PhonePostPaidSuccessWidget(
                    widget: widget,
...
class PhonePostPaidSuccessWidget extends StatelessWidget {
  const PhonePostPaidSuccessWidget({
    super.key,
  ...
  final PhonePostpaidSuccessPage widget;
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      convertToIdr(
                          widget.billingAmount +
                              ...
                              widget.serviceFee +
                              PhonePostpaidSuccessPage.uniqueCode,
                          0),
                      style: GoogleFonts.poppins(
                        fontSize: 24.sp,
                        fontWeight: FontWeightResource.semiBold,
                    ...
                    StartEndTextRowWidget(
                      ...
                      endText:
                          convertToIdr(PhonePostpaidSuccessPage.uniqueCode, 0),
                    ),
                  ],
                ),
              ),
