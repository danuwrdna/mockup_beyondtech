...
class SingleTransferDestinationBottomSheet extends StatefulWidget {
  const SingleTransferDestinationBottomSheet({super.key});

  @override
  State<SingleTransferDestinationBottomSheet> createState() =>
      _SingleTransferDestinationBottomSheetState();
}

class _SingleTransferDestinationBottomSheetState
    extends State<SingleTransferDestinationBottomSheet> {
  ...
  // void initState() {
  //   context
  //       .read<SingleTransferBankListBloc>()
  //       .add(const SingleTransferBankListEvent.getBankList());
  //   super.initState();
  // }
  ...
  Widget build(BuildContext context) {
    ...
    //   listeners: [
    //     BlocListener<SingleTransferBankListBloc, SingleTransferBankListState>(
    ...
    //       },
    //     ),
    //     BlocListener<SingleTransferVerifyRecipientBloc,
            ...
            child: Column(
              ...
              children: [
                ...
                LabeledTextField(
                  ...
                  suffix: InkWell(
                    onTap: () {
                      if (selectedDestinationBank == null) {
                        setState(() {
                          accountNumberError =
                              "Please choose a destination bank before proceeding.";
                        });
                      } else {
                        // context.read<SingleTransferVerifyRecipientBloc>().add(
                              ...
                              MaterialPageRoute(
                                builder: (context) {
                                  return SingleTransferNominalPage(
                                    ...
                                    bankData: selectedDestinationBank!,
                                  );
                                },
                              ),
                            );
