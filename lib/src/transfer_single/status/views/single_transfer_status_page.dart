...
class SingleTransferStatusPage extends StatefulWidget {
  const SingleTransferStatusPage({
    super.key,
    this.refId,
    this.recipient,
  });
  ...
  @override
  State<SingleTransferStatusPage> createState() =>
      _SingleTransferStatusPageState();
}

class _SingleTransferStatusPageState extends State<SingleTransferStatusPage> {
