...
class SingleTransferReviewPage extends StatelessWidget {
  const SingleTransferReviewPage({super.key, this.transactionData});

  final TransferSingleResponseData? transactionData;
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Expanded(
                            child: Text(
                              "Finish Before ${DateFormat("dd MMM yyyy, HH:mm").format(DateTime.fromMillisecondsSinceEpoch((transactionData?.expiredAt ?? 0) * 1000))} WIB",
                          ...
                          Container(
                            ...
                            child: CountdownWidget(
                              time: DateTime.fromMillisecondsSinceEpoch(
                                (transactionData?.expiredAt ?? 0) * 1000,
                              ),
                              textStyle: TextStyle(
                                fontSize: 10.sp,
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                if (transactionData?.paymentCode ==
                      ...
                      child: Column(
                        ...
                        children: [
                          StartEndTextRowWidget(
                            ...
                            endText: transactionData?.formatted?.price ?? "",
                          ),
                          const SizedBox(height: 12),
                          StartEndTextRowWidget(
                            startText: "Unique Code",
                            endText:
                                transactionData?.formatted?.uniqueCode ?? "",
                          ),
                          const SizedBox(height: 20),
                          Container(
                            ...
                            child: StartEndTextRowWidget(
                              ...
                              endText:
                                  transactionData?.formatted?.totalAmount ?? "",
                            ),
                          ),
                        ],
                      ),
