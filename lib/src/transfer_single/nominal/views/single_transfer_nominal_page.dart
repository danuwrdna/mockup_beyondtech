...
import 'package:bpay_mobile/src/transfer_single/detail/views/single_transfer_detail_page.dart';
...
class SingleTransferNominalPage extends StatefulWidget {
  const SingleTransferNominalPage({
    super.key,
  ...
  @override
  State<SingleTransferNominalPage> createState() =>
      _SingleTransferNominalPageState();
}

class _SingleTransferNominalPageState extends State<SingleTransferNominalPage> {
  List<int> nominal = [];
                    ...
                    onNext: () {
                      if ((int.tryParse(nominal.join("")) ?? 0) < 10000) {
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) {
                              return SingleTransferDetailPage(
                                nominal: int.tryParse(nominal.join("")) ?? 0,
